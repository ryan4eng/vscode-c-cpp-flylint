...
export class CppCheck extends Linter {
    ...
    protected parseLine(line: string): InternalDiagnostic | null {
        ...
        let excludeRegex = /^((Checking |Active checkers:|Defines:|Undefines:|Includes:|Platform:|.*information.*missingInclude.*).*|cppcheck: .*. Disabling .* check.|nofile .*|.*Limiting analysis of branches.*)$/;
